...
@EntityScan("com.remotegroup.businessintelligence.businessIntelligence.domain")
@EnableJpaRepositories("com.remotegroup.businessintelligence.businessIntelligence.persistence")
